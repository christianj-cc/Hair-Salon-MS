...
<div class="py-3">
    ...
    <div class="bg-white rounded-lg shadow p-3 mb-6">
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('admin.customers.archived') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">Clear</a>
        </div>
    </div>

    <form id="filter-form" method="GET" action="{{ route('admin.customers.archived') }}" class="hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <button @click="confirmAction('Restore Customer', 'Are you sure you want to restore this customer?', 
                        '{{ route('admin.customers.restore', $customer->id) }}', 'POST', 'Restore', true)" class="text-green-600 hover:text-green-900" title="Restore">
