...
<div class="py-3">
    <div class="flex items-center mb-6">
        <a href="{{ route('admin.appointments.show', $appointment) }}" class="inline-flex items-center text-gray-500 hover:text-primary transition mr-4">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-6">
                <form id="assignForm" method="POST" action="{{ route('admin.appointments.assign', $appointment) }}"
