...
<div class="py-3">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form id="createEmployeeForm" method="POST" action="{{ route('admin.employees.store') }}" enctype="multipart/form-data"
            x-data="{
                ...
                validatePersonalEmail() {
                    const email = this.personal_email;
                    if (email === '') {
                ...
                clearPersonalEmailError() { this.personalEmailError = ''; },
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="lg:w-2/3">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- Personal Email (for invitation) -->
                        <div>
                            <label for="personal_email" class="block text-sm font-medium text-gray-700">Personal Email (for invitation) <span class="text-red-500">*</span></label>
                            <input type="email" name="personal_email" id="personal_email" placeholder="example@gmail.com" x-model="personal_email"
                                @blur="validatePersonalEmail()" @focus="clearPersonalEmailError()"
                                :class="personalEmailError ? 'border-red-500 focus:border-red-500' : 'border-gray-300'"
                                class="mt-1 block w-full rounded-md shadow-sm focus:border-primary focus:ring-primary" required>
                            <div x-show="personalEmailError" x-text="personalEmailError" class="text-red-500 text-xs mt-1"></div>
                        ...
                        <div>
                            ...
                            <select name="job_role_id" id="job_role_id" x-model="job_role_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-primary focus:ring-primary" required>
                                ...
                                <option value="{{ $role->id }}" {{ old('job_role_id') == $role->id ? 'selected' : '' }}>{{ $role->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="hire_date" id="hire_date" x-model="hire_date" value="{{ old('hire_date') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-primary focus:ring-primary" required>
                    ...
                    <div class="mt-6 flex gap-4">
                        ...
                        <button type="button"
                            ...
                            :disabled="!isComplete"
                            @click="confirmAction('Create Employee', 'Are you sure you want to create this employee?', '#createEmployeeForm', 'POST', 'Create', true)">
                            Create Employee
                        </button>
                    </div>
                </div>
