...
<head>
    ...
    <title>{{ config('app.name', 'Hair Salon MS') }} - Admin</title>
                ...
                <nav class="sidebar-nav flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.dashboard') }}"
                        ...
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.dashboard') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                    ...
                    <a href="{{ route('admin.appointments.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.appointments.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span x-show="sidebarExpanded" x-cloak>Appointments</span>
                    </a>
                    ...
                    <a href="{{ route('admin.customers.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.customers.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                        <span x-show="sidebarExpanded" x-cloak>Customers</span>
                    </a>
                    ...
                    <a href="{{ route('admin.employees.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.employees.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        <span x-show="sidebarExpanded" x-cloak>Employees</span>
                    </a>

                    <!-- Services - Updated with scissors icon -->
                    <a href="{{ route('admin.services.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.services.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <!-- Handles -->
                            ...
                            <!-- Blades -->
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 4L8.12 15.88" />

                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.47 14.48L20 20" />

                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.12 8.12L12 12" />
                        </svg>
                        <span x-show="sidebarExpanded" x-cloak>Services</span>
                    </a>

                    <!-- Inventory - Updated with salon product/shampoo bottle icon -->
                    <a href="{{ route('admin.products.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.products.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        ...
                        <span x-show="sidebarExpanded" x-cloak>Inventory</span>
                    </a>
                    ...
                    <a href="{{ route('admin.discounts.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.discounts.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                        </svg>
                        <span x-show="sidebarExpanded" x-cloak>Promos</span>
                    </a>
                    ...
                    <a href="{{ route('admin.reports.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.reports.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <!-- Sales Report - Filled Bar Graph -->
                        <svg class="w-6 h-6 flex-shrink-0"
                            :class="sidebarExpanded ? 'mr-3' : 'mr-0'"
                            viewBox="0 0 24 24"
                            fill="currentColor">
                            ...
                            <!-- Bottom Line -->
                            <rect x="4" y="19" width="16" height="2" rx="0.75" />
                        </svg>
                        <span x-show="sidebarExpanded" x-cloak>Reports</span>
                    </a>
                    ...
                    <a href="{{ route('admin.audit_logs.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('admin.audit_logs.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <!-- Audit Logs -->
                        <svg class="w-6 h-6 flex-shrink-0"
                            :class="sidebarExpanded ? 'mr-3' : 'mr-0'"
                            fill="none"
                            ...
                            <path stroke-linecap="round"
                                stroke-linejoin="round"
                                stroke-width="2"
                                d="M9 3h6l1 2h3a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V6a1 1 0 011-1h3l1-2z" />
                        ...
                        <span x-show="sidebarExpanded" x-cloak>Audit Logs</span>
                    </a>
                </nav>
