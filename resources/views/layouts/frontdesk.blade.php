...
<head>
    ...
    <title>{{ config('app.name', 'Hair Salon MS') }} - Front Desk</title>
                ...
                <nav class="sidebar-nav flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('frontdesk.dashboard') }}"
                        ...
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('frontdesk.dashboard') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                    ...
                    <a href="{{ route('frontdesk.appointments.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('frontdesk.appointments.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Validate Payments -->
                    <a href="{{ route('frontdesk.payments.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('frontdesk.payments.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span x-show="sidebarExpanded" x-cloak>Validate Payments</span>
                    </a>

                    <!-- Customers -->
                    <a href="{{ route('frontdesk.customers.index') }}"
                        :class="sidebarExpanded ? 'justify-start px-4' : 'justify-center px-2'"
                        class="flex items-center py-3 text-sm font-medium rounded-md whitespace-nowrap transition-all
                               {{ request()->routeIs('frontdesk.customers.*') ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                        <svg class="w-6 h-6 flex-shrink-0" :class="sidebarExpanded ? 'mr-3' : 'mr-0'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
