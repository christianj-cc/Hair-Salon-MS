...
<div class="py-3">
    <div class="flex items-center mb-6">
        <a href="{{ route('frontdesk.appointments.index') }}" class="inline-flex items-center text-gray-500 hover:text-primary transition mr-4">
...
<div class="bg-transparent grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <div class="space-x-2">
                <a href="{{ route('frontdesk.customers.show', $appointment->customer->id) }}"
...
<div class="bg-white rounded-lg shadow overflow-hidden mt-6">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('frontdesk.appointments.edit', $appointment) }}" class="text-primary hover:text-primary-dark">
    ...
    <div class="px-6 py-4 border-t border-gray-200 flex justify-between items-center">
        <div>
            ...
            <button @click="confirmAction('Cancel Appointment', 'Are you sure you want to cancel this appointment?', '{{ route('frontdesk.appointments.cancel', $appointment) }}', 'POST', 'Cancel Appointment', true, true)"
        ...
        <div class="space-x-2">
            ...
            <button type="button"
                @click="confirmAction('Mark as Paid', 'Are you sure you want to mark this appointment as paid?', '{{ route('frontdesk.appointments.mark-paid', $appointment) }}', 'PATCH', 'Mark as Paid', true)"
            ...
            <button type="button"
                @click="confirmAction('Mark as Completed', 'Are you sure you want to mark this appointment as completed?', '{{ route('frontdesk.appointments.complete', $appointment) }}', 'PATCH', 'Mark as Completed', true)"
