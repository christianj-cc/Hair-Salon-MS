...
<div class="py-3">
    ...
    <form id="createAppointmentForm" method="POST" autocomplete="off" action="{{ route('frontdesk.appointments.store') }}"
        x-data="{
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex gap-4">
                        <a href="{{ route('frontdesk.appointments.index') }}" class="bg-none text-gray-900 px-6 py-2 rounded-md hover:bg-primary-dark transition">Cancel</a>
                        <button type="button"
