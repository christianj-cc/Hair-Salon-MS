...
<div class="py-3">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form id="editAppointmentForm" method="POST" action="{{ route('frontdesk.appointments.update', $appointment) }}"
            x-data="{
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div x-show="payment_method === 'gcash'" x-transition>
                    <label for="gcash_reference" class="block text-sm font-medium text-gray-700">GCash Reference Number (13-digit) <span class="text-red-500">*</span><span class="text-red-500">*</span></label>
