...
<div class="py-3">
    <div class="flex items-center mb-6">
        <a href="{{ route('frontdesk.customers.show', $customer) }}" class="inline-flex items-center text-gray-500 hover:text-primary transition mr-4">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form id="editCustomerForm" method="POST" action="{{ route('frontdesk.customers.update', $customer) }}" enctype="multipart/form-data"
            x-data="{
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                        <label for="image" class="cursor-pointer block">
                            <div id="previewContainer" class="mb-4 flex justify-center">
                                ...
                                <div id="placeholder" class="w-full h-48 bg-gray-100 flex items-center justify-center {{ $customer->image ? '' : 'hidden' }}">
                            ...
                            <p class="text-sm text-gray-600">Click to change profile photo</p>
                ...
                <div class="lg:w-2/3">
                    ...
                    <div class="mt-6 flex gap-4">
                        ...
                        <button type="button"
                            ...
                            :disabled="!isComplete"
                            @click="confirmAction('Update Customer', 'Are you sure you want to update this customer?', '#editCustomerForm', 'POST', 'Update', true)">
                            Update Customer
                        </button>
                    </div>
                </div>
