    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <a href="{{ route('frontdesk.customers.history', $customer) }}" class="text-primary hover:text-primary-dark">
            ...
            <div class="p-6">
                ...
                <div class="mt-4 text-right">
                    <!--<a href="{{ route('frontdesk.customers.history', $customer) }}" class="text-primary hover:text-primary-dark font-medium">View Service History →</a>-->
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <a href="{{ route('frontdesk.customers.edit', $customer) }}" class="text-primary hover:text-primary-dark">
                    <svg class="w-5 h-5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
