...
<head>
    <title>Loyalty Discount Earned</title>
    <meta charset="utf-8">
                ...
                <table width="500" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 8px 20px rgba(0,0,0,0.05); overflow: hidden;">
                    ...
                    <tr>
                        <td style="background-color: #ae2810; padding: 30px 25px; text-align: center;">
                            ...
                            <p style="margin: 8px 0 0; color: #f9dbd5; font-size: 16px;">Loyalty Discount</p>
                        </td>
                    </tr>
                    <!-- Body -->
                    <tr>
                        <td style="padding: 35px 30px;">
                            ...
                            <p style="color: #4a627a; font-size: 16px; line-height: 1.5;">Congratulations! You have earned a <strong style="color: #ae2810;">10% loyalty discount</strong> on your next appointment.</p>

                            <div style="background-color: #f9f9fc; border-left: 4px solid #ae2810; padding: 12px 16px; margin: 25px 0; border-radius: 8px;">
                                <p style="margin: 0; font-size: 14px; color: #5a6e7c;">Your discount will be automatically applied when you book your next appointment (or you can choose to apply it manually via the checkbox).</p>
                            </div>

                            <p style="color: #4a627a; font-size: 16px; line-height: 1.5;">Thank you for being a loyal customer!</p>

                            <div style="text-align: center; margin: 35px 0;">
                                <a href="{{ route('customer.appointments.create') }}" style="background-color: #ae2810; color: #ffffff; padding: 14px 32px; border-radius: 40px; text-decoration: none; font-weight: 600; font-size: 16px; display: inline-block; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">Book Now</a>
                            </div>

                            <p style="color: #7e95ab; font-size: 14px;">We look forward to serving you again.</p>
                        </td>
                    </tr>
                    <!-- Footer -->
                    <tr>
